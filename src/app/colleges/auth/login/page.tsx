    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '420px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ color: '#64748b', fontSize: '0.9rem', fontWeight: 550 }}>Sign in to your VidyaKhoj account</p>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            fontSize: '0.8rem', color: '#1e40af', marginBottom: '1.5rem', lineHeight: 1.5,
            fontWeight: 500,
          }}>
            🎭 <strong>Demo Mode:</strong> Any valid email + password (6+ chars) will authenticate.
          </div>
        ...
        <p style={{ textAlign: 'center', color: '#64748b', fontSize: '0.9rem', marginTop: '1.5rem', fontWeight: 550 }}>
          ...
          <Link href={PLATFORM_ROUTES.register} style={{ color: '#0b4c8c', textDecoration: 'none', fontWeight: 700 }}>
            Create one free
          </Link>
        </p>
      </div>
